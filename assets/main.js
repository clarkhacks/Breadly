...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 500, intensity: 1, delay: 0, state: true, replay: false });
		onvisible.add('hr.style1', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, state: true, replay: false });
		onvisible.add('.buttons.style1', { style: 'zoom-in', speed: 500, intensity: 1, delay: 625, stagger: 125, state: true, replay: false });
		onvisible.add('.buttons.style2', { style: 'zoom-in', speed: 500, intensity: 1, delay: 625, stagger: 125, state: true, replay: false });
